...
## Evaluation Results (200 Sample Test)
...
**Overall Macro F1: 0.5689**

| Class | Precision | Recall | F1-Score | Support |
|-------|-----------|--------|----------|---------|
| supported | 0.5306 | 0.5652 | 0.5474 | 92 |
| not_supported | 0.6078 | 0.5741 | 0.5905 | 108 |

### Accuracy Breakdown

**Overall Accuracy: 57.00% (114/200)**

| Dataset | Correct | Total | Accuracy |
|---------|---------|-------|----------|
| HOVER | 39 | 100 | 39.00% |
| FEVEROUS | 34 | 70 | 48.57% |
| SciFact | 11 | 30 | 36.67% |
...
> **Note**: These results are from baseline/simulated predictions.
> For production results, configure LLM (Ollama/OpenAI) and run the full pipeline.
